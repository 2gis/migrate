...
import (
	...
	dStub "github.com/2gis/migrate/database/stub"
	"github.com/2gis/migrate/source"
	sStub "github.com/2gis/migrate/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/2gis/migrate/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/2gis/migrate/source/stub"`
